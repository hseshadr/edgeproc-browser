...
let webcryptoEd25519 = null;
async function webcryptoSupportsEd25519() {
...
async function verifyWebCrypto(pubkeyRaw32, message, signature) {
    const key = await crypto.subtle.importKey("raw", pubkeyRaw32, { name: "Ed25519" }, false, ["verify"]);
 ...
 */
export async function verifyEd25519(pubkeyRaw32, message, signatureBase64) {
    let ok;
    try {
