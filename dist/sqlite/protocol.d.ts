import type { SqliteStateBatchOptions, SqliteStateListOptions, SqliteStateMigration, SqliteStateMutation, SqliteStateStoreOptions } from "./database.js";
export type SqliteStateWorkerRequest = {
    ...
    readonly id: number;
    readonly operation: "integrity-check";
} | {
    readonly id: number;
